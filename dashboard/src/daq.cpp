    ...
    void CANManager::decode_can(Variables* variable_instance)
    {
        ...
        switch (id) {
            ...
            case 0x502: // MCAC_Power
                ...
                struct fe12_mcac_power_t acc_power_msg;
                fe12_mcac_power_unpack(&acc_power_msg, frame.data, frame.can_dlc);
                variable_instance->setaccum_power(
                    fe12_mcac_power_motor_power_decode(acc_power_msg.acc_power)
                );
                break;
